...
# offline source
'''
state_wise = pd.read_csv("/Users/Suman/Dropbox/isrc_data_repo_2020/Covid19_CSV_files/state_wise.csv")
state_wise = state_wise[state_wise['State_code'] != 'UN']
state_wise_daily = pd.read_csv("/Users/Suman/Dropbox/isrc_data_repo_2020/Covid19_CSV_files/state_wise_daily.csv")
'''
# online source 
...
for row in range(1,5):
    for col in range(1,4):
        ...
        merged = merged.loc[merged['Date'] >= lockdown]

        merged['D/R'] = merged['Deceased']/merged['Recovered']
        merged['A/C'] = merged['Active']/merged['Confirmed']
...
#fig.update_xaxes(x_range=[85, julian[-1]])

fig.update_layout(height=1000, width=900,
                 title_text='<b>Active/Confirmed Ratio (as on '+todaystr+')</b><br><i>Data Source: api.covid19india.org</i>', title_x=0.5,showlegend=False,template='ggplot2')
